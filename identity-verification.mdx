...
description: "Authenticate users in your Crow widget for persistent conversations and personalized experiences"
---
...
3. **Check token isn't expired** — `exp` should be in the future
