---
title: "MCP Servers"
description: "Give your Crow agent access to MCP tools"
---

Give your Crow agent the ability to use tools from any MCP (Model Context Protocol) server. Once connected, your agent can call these tools to answer user questions and take actions.
